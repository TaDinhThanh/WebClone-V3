...
//        dd(substr($domain,0,$last));
        $key = DB::table('hwp_keys')->select('hwp_keys.id', 'ten', 'tien_to', 'hau_to', 'url_key_cha', 'id_cam','hwp_campaigns.language')
            ->join('hwp_campaigns','hwp_campaigns.id','=','hwp_keys.id_cam')
            ->where('url_key_cha', '=', $url_key)->first();
        $post_detail = DB::table('hwp_posts')
            ->select('hwp_posts.post_author', 'hwp_urls.url', 'hwp_posts.ID', 'hwp_posts.post_date', 'hwp_posts.post_content', 'hwp_posts.post_title', 'hwp_posts.post_view', 'hwp_posts.post_name',
                'hwp_posts.menu_order', 'hwp_yoast_indexables.twitter_image', 'hwp_yoast_indexables.permalink', 'hwp_yoast_indexables.title', 'hwp_yoast_indexables.description', 'hwp_yoast_indexables.breadcrumb_title'
                , 'hwp_yoast_indexables.primary_focus_keyword', 'hwp_yoast_indexables.meta_robot', 'hwp_keys.url_key_cha','hwp_yoast_indexables.twitter_description')
...
//                ->where('hwp_posts.post_title','LIKE','%xây dựng%')->limit()
        ...
        foreach ($select_list_chu_de_noi_bat as $value) {
            $post_detail2 =
                DB::table('hwp_posts')
                    ->select('hwp_posts.post_name', 'hwp_posts.post_title', 'hwp_yoast_indexables.twitter_image', 'hwp_posts.post_content', 'hwp_yoast_indexables.description')
                    ->join('hwp_yoast_indexables', 'hwp_yoast_indexables.object_id', '=', 'hwp_posts.id')
...
//        dd(substr($domain,0,$last));
//        try {
        $key = DB::table('hwp_keys')->select('hwp_keys.id', 'ten', 'tien_to', 'hau_to','ky_hieu', 'url_key_cha', 'id_cam','hwp_campaigns.language')
            ->join('hwp_campaigns','hwp_campaigns.id','=','hwp_keys.id_cam')
            ->where('url_key_cha', '=', $url_key)
            ->where('hwp_keys.id','=',$id_key)->first();

        if (!empty($key->ky_hieu)){
            return TopListController::home_wiki_new($url_key,$id_key);
        }
        $video = DB::table('hwp_videos')->where('hwp_videos.id_key','=',$key->id)->first();
        ...
        $post_detail = DB::table('hwp_posts')
            ->select('hwp_posts.post_author', 'hwp_urls.url', 'hwp_posts.ID', 'hwp_posts.post_date', 'hwp_posts.post_content', 'hwp_posts.post_title', 'hwp_posts.post_view', 'hwp_posts.post_name',
                'hwp_posts.menu_order', 'hwp_yoast_indexables.twitter_image', 'hwp_yoast_indexables.permalink', 'hwp_yoast_indexables.title', 'hwp_yoast_indexables.description', 'hwp_yoast_indexables.breadcrumb_title'
                , 'hwp_yoast_indexables.primary_focus_keyword', 'hwp_yoast_indexables.meta_robot')
            ->join('hwp_yoast_indexables', 'hwp_yoast_indexables.object_id', '=', 'hwp_posts.id')
            ->join('hwp_keys', 'hwp_keys.id', '=', 'hwp_posts.id_key')
            ->join('hwp_urls', 'hwp_urls.id', '=', 'hwp_posts.id_url')
            ->where('url_key_cha', '=', $url_key)
...
//
//        dd(substr($domain,0,$last));
        $key = DB::table('hwp_keys')->select('ten', 'tien_to', 'hau_to', 'url_key_cha')
            ->where('url_key_cha', '=', $url_key)->first();
        $post_detail = DB::table('hwp_posts')
            ->select('hwp_posts.post_author', 'hwp_urls.url', 'hwp_posts.ID', 'hwp_posts.post_date', 'hwp_posts.post_content', 'hwp_posts.post_title', 'hwp_posts.post_view', 'hwp_posts.post_name',
                'hwp_posts.menu_order', 'hwp_yoast_indexables.twitter_image', 'hwp_yoast_indexables.permalink', 'hwp_yoast_indexables.title', 'hwp_yoast_indexables.description', 'hwp_yoast_indexables.breadcrumb_title'
                , 'hwp_yoast_indexables.primary_focus_keyword', 'hwp_yoast_indexables.meta_robot', 'hwp_keys.url_key_cha')
            ->join('hwp_yoast_indexables', 'hwp_yoast_indexables.object_id', '=', 'hwp_posts.id')
            ->join('hwp_keys', 'hwp_keys.id', '=', 'hwp_posts.id_key')
            ->join('hwp_urls', 'hwp_urls.id', '=', 'hwp_posts.id_url')
            ->where('url_key_cha', '=', $url_key)
        ...
        try {
            $post_detail = DB::table('hwp_posts')
                ->select('hwp_posts.post_author', 'hwp_posts.ID', 'hwp_posts.post_date', 'hwp_posts.post_content', 'hwp_posts.post_title', 'hwp_posts.post_view', 'hwp_posts.menu_order', 'hwp_posts.id_key',
                    'hwp_yoast_indexables.twitter_image', 'hwp_yoast_indexables.permalink', 'hwp_yoast_indexables.title', 'hwp_yoast_indexables.description', 'hwp_yoast_indexables.breadcrumb_title'
                    , 'hwp_yoast_indexables.primary_focus_keyword', 'hwp_yoast_indexables.meta_robot')
                ->join('hwp_yoast_indexables', 'hwp_yoast_indexables.object_id', '=', 'hwp_posts.id')
                ->join('hwp_keys', 'hwp_keys.id', '=', 'hwp_posts.id_key')
...
//        dd($post_view);
            ...
            $list_bv_tham_khao = DB::table('hwp_posts')
                ->select('hwp_posts.post_title', 'hwp_posts.post_name', 'hwp_yoast_indexables.twitter_image', 'hwp_yoast_indexables.description')
                ->join('hwp_yoast_indexables', 'hwp_yoast_indexables.object_id', '=', 'hwp_posts.id')
            ...
            $url_tong_hop = DB::table('hwp_keys')->select('url_key_cha', 'tien_to', 'ten', 'hau_to')->where('id', '=', $post_detail[0]->id_key)->first();
...
//        dd($imageUrls);
        ...
        $list_url = DB::table('hwp_urls')
            ->select('hwp_posts.post_author', 'hwp_urls.url','hwp_urls.url_title', 'hwp_urls.url_image','hwp_urls.url_description','hwp_urls.ky_hieu', 'hwp_posts.ID', 'hwp_posts.post_date', 'hwp_posts.post_content', 'hwp_posts.post_title', 'hwp_posts.post_view', 'hwp_posts.post_name',
                'hwp_posts.menu_order', 'hwp_yoast_indexables.twitter_image', 'hwp_yoast_indexables.permalink', 'hwp_yoast_indexables.description', 'hwp_yoast_indexables.breadcrumb_title'
                , 'hwp_yoast_indexables.primary_focus_keyword', 'hwp_yoast_indexables.meta_robot')
